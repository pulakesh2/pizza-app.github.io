...
function Order() {
  ...
  return (
    <div className="py-6 px-4 space-y-8">
      <div className="flex itms-center justify-between flex-wrap gap-2">
        <h2 className="text-xl font-semibld">Order #{id} status</h2>
      ...
      <div className="flex itms-center justify-between flex-wrap gap-2 bg-stone-200 py-5 px-6">
